		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"padding":"20px 0px 0","margin":"0 0 0px","borderColor":"#ececde","borderStyle":"solid","background":"#fff","borderWidth":"1px 1px 0 "}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0 0 20px","margin":"0 auto","borderColor":"#ececde","borderRadius":"0px","textAlign":"center","background":"none","borderWidth":"0 0 1px","display":"block","borderStyle":"solid"}' >
					...
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"50px","fontSize":"16px","fontWeight":"500","height":"50px"}' class="item-label">房间号</label>
					...
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"inline-block","lineHeight":"50px","fontSize":"16px","fontWeight":"500","height":"50px"}' class="item-label">等级时间</label>
						<el-date-picker v-model="searchForm.dengjishijianstart" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd HH:mm:ss" placeholder="等级时间起始"></el-date-picker>
						至
						<el-date-picker v-model="searchForm.dengjishijianend" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd HH:mm:ss" placeholder="等级时间结束"></el-date-picker>
					</div>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true'  
						prop="shangcesuocishu"
					label="上厕所次数">
						<template slot-scope="scope">
							{{scope.row.shangcesuocishu}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
						prop="chuangdangenghuanshijian"
					label="床单更换时间">
						<template slot-scope="scope">
							{{scope.row.chuangdangenghuanshijian}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"1px solid #85bfeb","cursor":"pointer","padding":"0 10px 0 26px","margin":"0 5px 6px","outline":"none","color":"#1e98f5","borderRadius":"20px","background":"url(http://codegen.caihongy.cn/20230329/38553f099fa74a2d86e2206c373a9539.png) no-repeat 5px center / 20px","width":"auto","fontSize":"15px","height":"32px"}' v-if=" isAuth('hulijilu','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"1px solid #a4dbdd","cursor":"pointer","padding":"0 10px 0 26px","margin":"0 5px 6px","outline":"none","color":"#15a4aa","borderRadius":"20px","background":"url(http://codegen.caihongy.cn/20230329/99f867042acb4c4aae637c8bfcf6714a.png) no-repeat 3px center","width":"auto","fontSize":"15px","height":"32px"}' v-if=" isAuth('hulijilu','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"1px solid #e68080","cursor":"pointer","padding":"0 10px 0 26px","margin":"0 5px 6px","outline":"none","color":"#c00","borderRadius":"20px","background":"url(http://codegen.caihongy.cn/20230329/c5ea125f385740a3a3b9aed07f5dfe2c.png) no-repeat 5px center / 20px","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('hulijilu','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
